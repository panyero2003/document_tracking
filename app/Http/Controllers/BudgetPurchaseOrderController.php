...
class BudgetPurchaseOrderController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('budget.purchase_order.index', compact('purchase_orders'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('budget.purchase_order.edit', compact('purchase_orders'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/bud_purchase_order');
    }
