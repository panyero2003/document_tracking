...
@section('content')
   ...
   <br><br>
      ...
      <form class="example" action="{{ route('user_search_payroll_result') }}" method = "GET" role="search" >

      	        		
  		<input type="text" placeholder="Type Payroll Number to Search.." name="term" required>
