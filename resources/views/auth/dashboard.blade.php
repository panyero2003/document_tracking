...
<head>
  ...
  <title>Document Tracking System | Blank Page</title>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Welcome: {{ Auth::user()->name }} <span class="caret"></span>
                            </a>
